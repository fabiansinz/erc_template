...
\subsubsection{Workpackage 3.1: Reinforcement learning with embodied twin agent\hfill\objwp{3}{1}}
\labelobjwp{3}{1}
...
\subsubsection{Workpackage 3.2: Quantifying the effect of behavioral tuning changes\hfill\objwp{3}{2}}
\labelobjwp{3}{2}

\subsubsection{Workpackage 3.3: Quantifying the effect of causal manipulation\hfill\objwp{3}{3}}
\labelobjwp{3}{3}
